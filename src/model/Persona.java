...
public class Persona {
    ...
    public Persona(String nombre, String apellidos) {
        ...
        this.direccion = new SimpleStringProperty("Plaza de cuba");
        this.ciudad = new SimpleStringProperty("Toledo");
        this.codigoPostal = new SimpleIntegerProperty(45004);
        this.fechaDeNacimiento = new SimpleObjectProperty(LocalDate.of(1995, 4, 7));
